...
function P1show() {
  ...
  id1.style =
    "background-color: #008080; color: #ffffff; font-size: 4em; border-radius: 25px; border: #ffffff 4px solid; margin: 20px; padding: 15px; padding-left: 90px; padding-right: 90px;";
  ...
  img.innerHTML =
    "<img src='Breeds/german.webp' style='object-fit: cover; width: 100%; height: 100%; border-radius: 25px;'>";
...
function P2show() {
  ...
  var img = document.getElementById("image");
  img.innerHTML =
    "<img src='Breeds/main.jpg' style='object-fit: cover; width: 100%; height: 100%; border-radius: 25px;'>";
  var id1 = document.getElementById("p1");
